...
- `POST /api/send-confirmation` — email de confirmation d'inscription via Gmail
...
| `GMAIL_USER` | `api/send-confirmation.js` |
| `GMAIL_APP_PASSWORD` | `api/send-confirmation.js` |
| `GMAIL_FROM_NAME` | `api/send-confirmation.js` (optionnel, défaut : "Ohlun'Joie") |
