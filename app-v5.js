...
function setupAdminEventForms() {
  ...
  if (editForm) {
    editForm.onsubmit = async function(e) {
      ...
      // Attempt to update the event.  Supabase may return an error if the
      // current user lacks the proper row‑level security permissions or if
      // another constraint is violated.  Capture the error and surface it to
      // the admin instead of silently failing.
